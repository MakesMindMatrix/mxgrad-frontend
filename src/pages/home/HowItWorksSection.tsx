  ...
  return (
    <section id="how-it-works" className="py-24 bg-white scroll-mt-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Top-to-bottom flow: vertical dotted line with 4 dots; cards alternate left/right of line */}
        <div className="relative hidden md:block max-w-4xl mx-auto">
          {/* Vertical dotted line down the center */}
          <div
          ...
          <div className="relative flex flex-col gap-8">
            {STEPS.map((step, i) => {
              const isLeft = i % 2 === 0; // 1st & 3rd left, 2nd & 4th right
              return (
                <motion.div
                  key={step.title}
                ...
                >
                    ...
                    {isLeft && (
                      <motion.div
                        whileHover={{
                          y: -8,
                          scale: 1.02,
                          boxShadow: '0 24px 48px -12px rgba(11, 31, 58, 0.18), 0 0 0 1px rgba(37, 99, 235, 0.08)',
                        }}
                        transition={{ type: 'spring', stiffness: 350, damping: 22 }}
                        className="relative w-full max-w-[280px] p-6 rounded-xl border border-home-text-dark/10 bg-white shadow-lg hover:border-home-accent/20 transition-all duration-300 cursor-default group"
                      >
                  ...
                  <div
                    className="w-4 h-4 rounded-full bg-home-accent border-[3px] border-white shadow-md z-10 flex-shrink-0"
                    aria-hidden
                  />

                  {/* Right column: card when !isLeft */}
